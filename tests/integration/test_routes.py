...
class TestCreateUrl:
    ...
    def test_short_code_is_base62_of_id(self, client):
        ...
        r = client.post("/api/urls", json={"original_url": "https://example.com/base62"})
        data = r.get_json()
    ...
    def test_create_records_created_event(self, client, app):
        client.post("/api/urls", json={"original_url": "https://example.com/event-test"})
...
class TestRedirect:
    def test_redirect_302(self, client):
        r = client.post("/api/urls", json={"original_url": "https://target.example.com"})
    ...
    def test_inactive_url_returns_404(self, client):
        r = client.post("/api/urls", json={"original_url": "https://example.com/inactive"})
